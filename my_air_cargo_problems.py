...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list: #here
        ...
        kb = PropKB(decoded_state.sentence())
...
def air_cargo_p2() -> AirCargoProblem: # here
    cargos = ['C1', 'C2', 'C3']
    planes = ['P1', 'P2', 'P3']
...
def air_cargo_p3() -> AirCargoProblem: # here
    cargos = ['C1', 'C2', 'C3', 'C4']
    planes = ['P1', 'P2']
